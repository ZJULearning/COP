...
mkdir -p $train_dir
CUDA_VISIBLE_DEVICES=0,1 python -u train.py --train_dir=$train_dir --dataset="imagenet" --data_dir="./data" \
...
mkdir -p $train_dir
CUDA_VISIBLE_DEVICES=5,7 python -u train.py --train_dir=$train_dir --dataset="imagenet" --data_dir="./data" \
